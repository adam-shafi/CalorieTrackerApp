...
import androidx.compose.ui.unit.dp
import com.example.calorietracker.ui.theme.dimen_46dp
import com.example.calorietracker.ui.theme.dimen_8dp


@Composable
fun LinearProgressBar(indicatorProgress: Int) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .fillMaxWidth()
        ...
        LinearProgressBar(indicatorNumber = indicatorProgress)
    }
}
...
fun LinearProgressBar(
    ...
    indicatorNumber: Int,
    backgroundIndicatorColor: Color = MaterialTheme.colorScheme.primary.copy(alpha = 0.2f),
