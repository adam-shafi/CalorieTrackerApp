...
sealed class AutoSizeConstraint(open val min: TextUnit = TextUnit.Unspecified) {
    ...
    data class All(override val min: TextUnit = TextUnit.Unspecified): AutoSizeConstraint(min)
}
@Composable
fun AutoSizeText(
...
fun AutoSizeText(
    ...
    maxLines: Int = Int.MAX_VALUE,
    style: TextStyle = LocalTextStyle.current,
    constraint: AutoSizeConstraint = AutoSizeConstraint.All(),
) {
    AutoSizeText(
        modifier = modifier,
